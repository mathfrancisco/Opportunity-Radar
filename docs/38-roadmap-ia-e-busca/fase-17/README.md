...
| 2 | [F17-02 — área da vaga](f17-02-area-da-vaga.md) | F17-01, F18-07 | Em revisão |
...
| 6 | [F17-06 — normalização mais precisa](f17-06-normalizacao-mais-precisa.md) | F17-01 | Em andamento — só `seniority-v2` (títulos PT + abreviações) entrou; `skills-v2`, `regions-v1`/`allowed_countries`, filtro de país no Inbox e reprocessamento sem `source_updated_at` seguem pendentes |
