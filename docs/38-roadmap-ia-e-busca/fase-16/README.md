...
| --- | --- | --- | --- |
| 1 | [F16-01 — GPU, imagem 0.34.4, `ollama-init` e perfis](f16-01-gpu-imagem-e-perfis.md) | Nenhum | Implementação integrada (PR #18); aceite documental pendente |
| 2 | [F16-02 — `qwen3:8b-q4_K_M` como padrão e opções da chamada](f16-02-qwen3-padrao-e-opcoes.md) | F16-01 | Implementação integrada (PR #18); aceite documental pendente |
| 3 | [F16-03 — custo de cada análise](f16-03-custo-de-cada-analise.md) | F16-02 | Implementação integrada (PR #18); aceite documental pendente |
| 4 | [F16-04 — aquecimento, `keep_alive` e fila por valor](f16-04-aquecimento-e-fila-por-valor.md) | F16-02 | Implementação integrada (PR #18); aceite documental pendente |
| 5 | [F16-05 — orçamento de tokens e limpador](f16-05-orcamento-de-tokens-e-limpador.md) | F16-03 | Base integrada (PR #20); reforços desta revisão pendentes |
| 6 | [F16-06 — conjunto de avaliação](f16-06-conjunto-de-avaliacao.md) | F16-03 | Em revisão — harness pronto; casos e baselines na máquina de referência |
| 7 | [F16-07 — vaga no payload e prompt `v2`](f16-07-vaga-no-payload-e-prompt-v2.md) | F16-05, F16-06, F16-08, F18-07 | Backlog |
| 8 | [F16-08 — cache persistente](f16-08-cache-persistente.md) | F16-03 | Base integrada (PR #20); identidade completa ainda pendente |
| 9 | [F16-09 — pgvector e embeddings](f16-09-pgvector-e-embeddings.md) | F16-01, F16-05 | Backlog |
...
| 13 | [F16-13 — métricas da análise](f16-13-metricas-da-analise.md) | F16-03 | Implementação integrada (PR #18); aceite documental pendente |

F16-09 depende da infraestrutura e do limpador F16-05.
F18-07 pode ser antecipado para preservar o perfil consumido pelo F16-07.
...
- com o Ollama fora do ar, o radar coleta, normaliza, avalia e mostra tudo, só sem o
  comentário;
- cortes conhecidos são registrados; estimativa de tokens tem margem e limites medidos;
